...
One person had been responsible for Instagram and some creative design. Jan automated Instagram entirely: [N8N](https://n8n.io) pulling from a Google Drive folder of product images, an LLM writing captions, scheduled posting. The [r/MarketingAutomation community has been documenting exactly this shift](https://www.reddit.com/r/MarketingAutomation/comments/1q9l2vs/agentic_marketing_ops_in_2026_a_safe_playbook_for/) — it is happening across industries, not just ours. Setup took a week. The role was no longer necessary.
...
The teams replacing traditional marketers are not AI systems. They are small teams of skilled operators running AI systems — a shift [Anthropic and other AI labs have been calling "agentic AI" since 2024](https://www.youtube.com/watch?v=bEvZvOhaQgs) — people who understand what agents can and cannot do, who know how to build the infrastructure, and who make the judgment calls that agents cannot.
