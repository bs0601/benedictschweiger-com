...
cover:
  image: "/images/blog/return-on-token-spend-og.png"
  alt: "The ROTS J-curve: from quick wins to flywheel"
  relative: false
hasFAQ: true
faq:
...
[Google's ROAS framework](https://support.google.com/google-ads/answer/6268637) is the direct parallel. It took years for advertisers to move from "how do I spend less?" to "how do I spend more because I know it works?" AI is making the same transition now. The question is who makes it first.
...
1. **Total AI spend** — tokens, API calls, hosting, model fine-tuning, vendor licences. Include everything that would disappear if you shut the workflow off.
2. **Value generated** — the business outcome the workflow produces. If it is content, value might be equivalent labour cost (what would a human have cost to produce the same output?) or attributed revenue (leads generated × conversion rate × deal value). If it is customer service, value is ticket resolution cost avoided. Be conservative. Round down.
3. **ROTS** — (Value − Spend) / Spend. A ROTS of 0.5 means every dollar spent returns $1.50 in value. A ROTS of 2.0 means every dollar returns $3.00.
...
The methodology that made this possible — validating everything on a personal test stand before touching the €20M business — is documented in [the test stand approach](/blog/before-i-touch-the-20m-business/).
...
This is what [agentic marketing](/blog/what-is-agentic-marketing/) looks like when it works. Not AI assisting humans. Humans directing agents that execute autonomously.
...
The fastest way to find out is the [AI Readiness Assessment](/ai-readiness/). Three questions. Thirty seconds.
...
**What is Return on Token Spend (ROTS)?**
...
*Want to know where your operation sits on the ROTS curve?* [Take the AI Readiness Assessment →](/ai-readiness/)
